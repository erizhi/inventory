<?php
ini_set('include_path', '.:/var/www/system-pepauto-com');
    ...
    * http://aws.amazon.com
    ***********************************************************************/
    define('AWS_ACCESS_KEY_ID', 'AKIAJJUPC6YSLWPDODSQ');
    define('AWS_SECRET_ACCESS_KEY', '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');
    ...
    * marketplace ID.
    ***********************************************************************/
    define ('MERCHANT_ID', 'A21TU95DWDYTHV');
