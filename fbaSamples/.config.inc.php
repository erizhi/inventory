<?php
    ...
    * http://mws.amazon.com
    ***********************************************************************/
     define('ACCESS_KEY_ID', 'AKIAJJUPC6YSLWPDODSQ');
     define('SECRET_ACCESS_KEY', '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');  
    ...
    ***********************************************************************/
    define('APPLICATION_NAME', 'iboyParts');
    ...
    ***********************************************************************/
    define ('SELLER_ID', 'A21TU95DWDYTHV');
    ...
    ***********************************************************************/
    define ('MWS_ENDPOINT_URL', 'https://mws.amazonservices.com/FulfillmentInventory/2010-10-01/');
